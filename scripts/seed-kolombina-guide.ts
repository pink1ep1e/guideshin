...
Реакции Коломбины работают с **Электро, Дендро и Гео** — с другими элементами синергии как у Лунного саппорта нет.`,
...

    {
      ...
      eyebrow: "Отряды",
      title: "Лунная бутонизация",
      intro: "Все варианты с Дендро-героями (wotpack):",
      variants: [
        variant(
        ...
        variant(
          "Альтернатива: Сахароза в Инструкторе поглощает Гидро для статуса и баффает МС.",
          [
            member(c("nefer", "нефер"), "Нефер", "Мейн-дд"),
            self("Саппорт"),
            member(c("lauma", "лаума"), "Лаума", "Саб-дд"),
        ...
        variant(
          "Бюджет без Лаумы: Нахида + Кокоми. Вместо Кокоми можно Айно в Серенаде.",
          [
            member(c("nefer", "нефер"), "Нефер", "Мейн-дд"),
            self("Саппорт"),
        ...
        variant(
          "Без Лаумы и Нахиды: Бай Чжу + Айно в Серенаде.",
          [
            member(c("nefer", "нефер"), "Нефер", "Мейн-дд"),
            self("Саппорт"),
            member(c("bay-chzhu", "бай чжу"), "Бай Чжу", "Саб-дд"),
    ...
    },
    {
      ...
      eyebrow: "Отряды",
      title: "Лунный заряд",
      intro: "Все группы через Электро (wotpack):",
      variants: [
        variant(
        ...
        variant(
          "Без Инеффы: Оророн предпочтительнее Фишль. Ягода выгоднее Сахарозы хилом, особенно с С6.",
          [
            member(c("flins", "флинс"), "Флинс", "Мейн-дд"),
            self("Саппорт"),
        ...
        variant(
          "Без Инеффы: Оророн + Сахароза при аккуратной игре без хила.",
          [
            member(c("flins", "флинс"), "Флинс", "Мейн-дд"),
            self("Саппорт"),
            member(c("ororon", "оророн"), "Оророн", "Саб-дд"),
        ...
        variant(
          "Бюджетный Электро саб-дд: Фишль + Ягода.",
          [
            member(c("flins", "флинс"), "Флинс", "Мейн-дд"),
            self("Саппорт"),
            member(c("fischl", "фишль"), "Фишль", "Саб-дд"),
            member(c("yagoda", "ягода"), "Ягода", "Хил"),
          ],
          "Бюджет",
        ),
        variant(
          "Если Электро саб-дд заняты: Куки в Инструкторе + Айно (второй Гидро и Серенада).",
          [
            member(c("flins", "флинс"), "Флинс", "Мейн-дд"),
            self("Саппорт"),
            member(c("kuki", "синобу"), "Синобу", "Хил"),
            member(c("ajno", "айно"), "Айно", "Гидро"),
          ],
          "Гибко",
        ),
    ...
    },
    {
      ...
      eyebrow: "Отряды",
      title: "Лунный кристалл",
      intro: "Все отряды с Гео-героями (wotpack):",
      variants: [
        variant(
          "Сигнатурный отряд Цзы Бай. Линнея уже лечит — Коломбине сигна или Кодекс Фавония.",
          [
        ...
        variant(
          "Без Линнеи: Горо желательно С4 на подхил. Иллуги — сигнатурный саппорт реакции.",
          [
            member(c("czy-baj", "цзы бай"), "Цзы Бай", "Мейн-дд"),
            self("Саппорт"),
            member(c("illugi", "иллуги"), "Иллуги", "Саб-дд"),
        ...
        variant(
          "Без Линнеи со Шилонен: желательно С2; иначе лучше Горо.",
          [
            member(c("czy-baj", "цзы бай"), "Цзы Бай", "Мейн-дд"),
            self("Саппорт"),
            member(c("illugi", "иллуги"), "Иллуги", "Саб-дд"),
            member(c("shilonen", "шилонен"), "Шилонен", "Бафф"),
          ],
          "Сильный",
        ),
        variant(
          "С Тиори: тотемы ЛК — Гео-конструкции. Коломбине лучше Прототип: Янтарь.",
          [
            member(c("czy-baj", "цзы бай"), "Цзы Бай", "Мейн-дд"),
            self("Саппорт"),
            member(c("illugi", "иллуги"), "Иллуги", "Саб-дд"),
            member(c("tiori", "тиори"), "Тиори", "Саб-дд"),
          ],
          "Альтернатива",
        ),
        variant(
          "С Чжун Ли вместо Тиори: дополнительно срезает сопротивление.",
          [
            member(c("czy-baj", "цзы бай"), "Цзы Бай", "Мейн-дд"),
            self("Саппорт"),
            member(c("illugi", "иллуги"), "Иллуги", "Саб-дд"),
        ...
        variant(
          "С Айно: желателен С6 под ЛК. Без С1 Куутар на щит — Прототип: Янтарь на Коломбину.",
          [
            member(c("czy-baj", "цзы бай"), "Цзы Бай", "Мейн-дд"),
            self("Саппорт"),
            member(c("ajno", "айно"), "Айно", "Гидро"),
...
- **Айно** — Гидро-резонанс и Высшее сияние; на С6 усиливает конвертированные реакции.`,
    },
    {
      ...
      type: "teamGroup",
      eyebrow: "Отряды",
      title: "Лунные реакции с обычными ДД",
      intro: "Все группы с обычными мейн-дд через конвертацию (wotpack):",
      variants: [
        variant(
          "Нёвиллет под щитом Инеффы. Куутар даёт Гидро-резонанс. Сахароза — бафф МС.",
          [
            member(c("neuvillette", "нёвиллет"), "Нёвиллет", "Мейн-дд"),
            self("Саппорт"),
            member(c("ineffa", "инеффа"), "Инеффа", "Саб-дд"),
            member(c("sucrose", "сахароза"), "Сахароза", "Флекс"),
          ],
        ...
        variant(
          "Нёвиллет + Инеффа + Ягода на подхил.",
          [
            member(c("neuvillette", "нёвиллет"), "Нёвиллет", "Мейн-дд"),
            self("Саппорт"),
            member(c("ineffa", "инеффа"), "Инеффа", "Саб-дд"),
        ...
        variant(
          "Нёвиллет + Инеффа + Лаума вместо Анемо.",
          [
            member(c("neuvillette", "нёвиллет"), "Нёвиллет", "Мейн-дд"),
            self("Саппорт"),
            member(c("ineffa", "инеффа"), "Инеффа", "Саб-дд"),
        ...
        variant(
          "Субретка-драйвер с Лаумой и Нахидой. Нилу — статус (лучше С2).",
          [
        ...
        variant(
          "Нилу + Лаума + Бай Чжу вместо Нахиды.",
          [
            member(c("nilou", "нилу"), "Нилу", "Мейн-дд"),
            self("Драйвер"),
            member(c("lauma", "лаума"), "Лаума", "Саб-дд"),
        ...
        variant(
          "Аль-Хайтам + Лаума, Куки на хил и взрыв бутонов.",
          [
            member(c("al-khaytam", "аль-хайтам"), "Аль-Хайтам", "Мейн-дд"),
            self("Саппорт"),
            member(c("lauma", "лаума"), "Лаума", "Саб-дд"),
            member(c("kuki", "синобу"), "Синобу", "Хил"),
          ],
        ...
        variant(
          "Аль-Хайтам + Лаума + Кокоми вместо Куки.",
          [
            member(c("al-khaytam", "аль-хайтам"), "Аль-Хайтам", "Мейн-дд"),
            self("Саппорт"),
            member(c("lauma", "лаума"), "Лаума", "Саб-дд"),
        ...
        variant(
          "Нёвиллет через Гео: Иллуги + Линнея. Лучше при С1 у юдекса.",
          [
            member(c("neuvillette", "нёвиллет"), "Нёвиллет", "Мейн-дд"),
            self("Саппорт"),
            member(c("illugi", "иллуги"), "Иллуги", "Саб-дд"),
        ...
        variant(
          "Нёвиллет через Гео с Тиори + Линнея.",
          [
            member(c("neuvillette", "нёвиллет"), "Нёвиллет", "Мейн-дд"),
            self("Саппорт"),
            member(c("tiori", "тиори"), "Тиори", "Саб-дд"),
        ...
        variant(
          "Навия под баффом Иллуги. Линнея важна для эндгейма.",
          [
            member(c("naviya", "навия"), "Навия", "Мейн-дд"),
            self("Саппорт"),
            member(c("illugi", "иллуги"), "Иллуги", "Саб-дд"),
            member(c("linneya", "линнея"), "Линнея", "Хил"),
          ],
        ...
        variant(
          "Навия + Иллуги + Кокоми вместо Линнеи.",
          [
            member(c("naviya", "навия"), "Навия", "Мейн-дд"),
            self("Саппорт"),
            member(c("illugi", "иллуги"), "Иллуги", "Саб-дд"),
        ...
        variant(
          "Без Цзы Бай: Итто через ЛК. Иллуги и Горо на защиту и Гео-дамаг.",
          [
        ...
        variant(
          "Ноэлль вместо Итто (желателен С6) + Линнея.",
          [
            member(c("noelle", "ноэлль"), "Ноэлль", "Мейн-дд"),
            self("Саппорт"),
            member(c("illugi", "иллуги"), "Иллуги", "Саб-дд"),
            member(c("linneya", "линнея"), "Линнея", "Хил"),
          ],
        ...
        variant(
          "Арлекино: смесь Пара, Перегрузки и Заряда. Ягода на флекс; хил менее критичен из-за щита Инеффы.",
          [
            member(c("arlekino", "арлекино"), "Арлекино", "Мейн-дд"),
            self("Саппорт"),
            member(c("ineffa", "инеффа"), "Инеффа", "Саб-дд"),
            member(c("yagoda", "ягода"), "Ягода", "Флекс"),
          ],
        ),
        variant(
          "Мавуика + Инеффа + Сахароза — та же логика смеси реакций.",
          [
            member(c("mavuika", "мавуика"), "Мавуика", "Мейн-дд"),
            self("Саппорт"),
            member(c("ineffa", "инеффа"), "Инеффа", "Саб-дд"),
            member(c("sucrose", "сахароза"), "Сахароза", "Флекс"),
          ],
    ...
    },
    {
      ...
      eyebrow: "Отряды",
      title: "Пар",
      intro: "Варианты с Пиро-героями (wotpack):",
      variants: [
        variant(
        ...
        variant(
          "Мавуика: Шилонен и Ситлали помогают откатывать ульту Пиро Архонта.",
          [
            member(c("mavuika", "мавуика"), "Мавуика", "Мейн-дд"),
            self("Саппорт"),
            member(c("shilonen", "шилонен"), "Шилонен", "Бафф"),
            member(c("sitlali", "ситлали"), "Ситлали", "Саб-дд"),
          ],
          "Топ",
        ),
        variant(
          "Ху Тао с Гео-резонансом: Чжун Ли на щит и срез резистов, Альбедо бьёт из кармана. Оба Гео резонируют с тотемами ЛК.",
          [
            member(c("hutao", "ху тао"), "Ху Тао", "Мейн-дд"),
            self("Саппорт"),
            member(c("albedo", "альбедо"), "Альбедо", "Саб-дд"),
            member(c("zhongli", "чжун ли"), "Чжун Ли", "Щит"),
          ],
        ),
      ],
    },
    {
      ...
      type: "teamGroup",
      eyebrow: "Отряды",
      title: "Заморозка и Таяние",
      intro: "Группы с Крио-компаньонами (wotpack):",
      variants: [
        variant(
          "Заморозка со Скирк: статус + HP-резонанс для Фурины.",
          [
            member(c("skirk", "скирк"), "Скирк", "Мейн-дд"),
            self("Саппорт"),
            member(c("eskofe", "эскофье"), "Эскофье", "Саб-дд"),
            member(c("furina", "фурина"), "Фурина", "Саб-дд"),
          ],
          "Заморозка",
        ),
        variant(
          "Ризли от Таяния: Беннет на АТК, Сян Лин на Пиро.",
          [
            member(c("wriothesley", "ризли"), "Ризли", "Мейн-дд"),
            self("Саппорт"),
            member(c("bennett", "беннет"), "Беннет", "Бафф"),
        ...
        variant(
          "Ризли + Беннет + Дурин вместо Сян Лин.",
          [
            member(c("wriothesley", "ризли"), "Ризли", "Мейн-дд"),
            self("Саппорт"),
            member(c("bennett", "беннет"), "Беннет", "Бафф"),
            member(c("durin", "дурин"), "Дурин", "Саб-дд"),
          ],
          "Таяние",
        ),
        variant(
          "Аяка через Заморозку: Эскофье + Кадзуха. Коломбина даёт много Гидро.",
          [
            member(c("ayaka", "аяка"), "Аяка", "Мейн-дд"),
            self("Саппорт"),
            member(c("eskofe", "эскофье"), "Эскофье", "Саб-дд"),
            member(c("kazuha", "кадзуха"), "Кадзуха", "Раздув"),
          ],
        ...
        variant(
          "Гань Юй + Шэнь Хэ + Кадзуха. Коломбине можно Прототип: Янтарь.",
          [
            member(c("ganyu", "гань юй"), "Гань Юй", "Мейн-дд"),
            self("Саппорт"),
            member(c("shen-khe", "шэнь хэ"), "Шэнь Хэ", "Бафф"),
            member(c("kazuha", "кадзуха"), "Кадзуха", "Раздув"),
          ],
          "Заморозка",
        ),
    ...
    },
    {
      ...
      type: "teamGroup",
      eyebrow: "Отряды",
      title: "Бутонизация, Вегетация и Заряжен",
      intro: "Все примеры с Дендро и Электро (wotpack):",
      variants: [
        variant(
          "Нахида-драйвер + Е Лань + Куки в МС на взрыв бутонов.",
          [
            member(c("nahida", "нахида"), "Нахида", "Драйвер"),
            self("Саб-дд"),
            member(c("yelan", "е лань"), "Е Лань", "Саб-дд"),
            member(c("kuki", "синобу"), "Синобу", "Хил"),
          ],
          "Вегетация",
        ),
        variant(
          ...
          [
            member(c("nahida", "нахида"), "Нахида", "Драйвер"),
            self("Саб-дд"),
            member(c("xingqiu", "син цю"), "Син Цю", "Саб-дд"),
            member(c("kuki", "синобу"), "Синобу", "Хил"),
          ],
          "Вегетация",
        ),
        variant(
          "Вегетация с Аль-Хайтамом: Фишль + Бай Чжу.",
          [
            member(c("al-khaytam", "аль-хайтам"), "Аль-Хайтам", "Мейн-дд"),
            self("Саппорт"),
            member(c("fischl", "фишль"), "Фишль", "Саб-дд"),
        ...
        variant(
          "Сайно + Фишль + Бай Чжу.",
          [
            member(c("cyno", "сайно"), "Сайно", "Мейн-дд"),
            self("Саппорт"),
            member(c("fischl", "фишль"), "Фишль", "Саб-дд"),
            member(c("bay-chzhu", "бай чжу"), "Бай Чжу", "Хил"),
          ],
        ...
        variant(
          "Бутонизация с Нилу: Бай Чжу приоритетнее Кокоми.",
          [
            member(c("nilou", "нилу"), "Нилу", "Мейн-дд"),
            self("Саппорт"),
            member(c("nahida", "нахида"), "Нахида", "Саб-дд"),
        ...
        variant(
          "Нилу + Нахида + Кокоми, если Бай Чжу нет.",
          [
            member(c("nilou", "нилу"), "Нилу", "Мейн-дд"),
            self("Саппорт"),
            member(c("nahida", "нахида"), "Нахида", "Саб-дд"),
        ...
        variant(
          "Нёвиллет через Электро: Куки + Оророн.",
          [
            member(c("neuvillette", "нёвиллет"), "Нёвиллет", "Мейн-дд"),
            self("Саппорт"),
            member(c("kuki", "синобу"), "Синобу", "Хил"),
        ...
        variant(
          "Аято + Куки + Райдэн.",
          [
            member(c("ayato", "аято"), "Аято", "Мейн-дд"),
            self("Саппорт"),
            member(c("kuki", "синобу"), "Синобу", "Хил"),
            member(c("shougun", "райдэн"), "Райдэн", "Саб-дд"),
          ],
          "Заряжен",
        ),
      ],
