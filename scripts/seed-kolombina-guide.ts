  ...
  const constellations = [
    {
      ...
      description:
        "Пока действует **Вечные приливы**, раз в 15 сек. срабатывает дополнительное **Вмешательство тяготения**.\n— Баффы отряду: энергия **Флинсу**, сопротивление прерыванию **Нефер**, щит **Цзы Бай**.\n— Урон Лунных реакций всех персонажей отряда поблизости возвышается на **7%**.",
      order: 0,
    },
    {
      id: "c2",
      level: 2,
      name: "Призрачный свет меж холмами и долинами",
      description:
        "Уровень навыка **Вечные приливы** +3 (макс. 15). Быстрее копится **Сила тяготения**, +40% HP и стат-баффы под тип реакции.\n— Урон Лунных реакций всех персонажей отряда поблизости возвышается на **1,5%**.",
      order: 1,
    },
    {
      id: "c3",
      level: 3,
      name: "Лунная роса на травах и водах",
      description:
        "Усиливает карманный урон и комфорт ротации. Лучшие консты по приоритету — **С1, С2 и С6**.\n— Урон Лунных реакций всех персонажей отряда поблизости возвышается на **1,5%**.",
      order: 2,
    },
    {
      id: "c4",
      ...
      description:
        "При активации восстанавливает **4** ед. энергии. Повышает урон реакций на **12,5% / 2,5% / 12,5%** от макс. HP (откат 15 сек.).\n— Урон Лунных реакций всех персонажей отряда поблизости возвышается на **1,5%**.",
      order: 3,
    },
    {
      id: "c5",
      level: 5,
      name: "Одинокая песнь под луной",
      description:
    ...
    },
    {
      id: "c6",
      level: 6,
      name: "Сквозь тьму к сиянию",
      description:
        "После Лунных реакций внутри ульты: **+80% К/У** соответствующим элементам на 8 сек. (не стакается на один элемент).\n— Урон Лунных реакций всех персонажей отряда поблизости возвышается на **7%**.",
      order: 5,
    },
  ];
