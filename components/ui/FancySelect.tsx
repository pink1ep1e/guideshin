  ...
  return (
    <div ref={rootRef} className={`relative ${className}`}>
      ...
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className={`flex w-full items-center gap-2 rounded-[14px] border border-black/[0.08] bg-white/95 ${pad} font-semibold text-foreground shadow-sm outline-none transition hover:border-[#189b8e]/40 focus:ring-2 focus:ring-[#189b8e]/25 ${
