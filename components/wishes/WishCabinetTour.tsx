...
const DASHBOARD_STEPS: WishTourStep[] = [
  ...
  },
  {
    id: "share",
    target: "tour-share",
    title: "Карточка для сторис",
    body: "Собирает PNG со статистикой, гарантами и последними 5★ за полгода — удобно кинуть в Telegram или Stories.",
  },
  {
    id: "compare",
    target: "tour-compare",
    title: "Сравнение аккаунтов",
    body: "Если профилей несколько, выберите второй и сравните молитвы, шансы и гаранты бок о бок.",
  },
  {
    id: "charts",
    target: "tour-charts",
