...
const DASHBOARD_STEPS: WishTourStep[] = [
  ...
  },
  {
    id: "luck",
    target: "tour-luck",
    title: "Достижения и прогноз",
    body: "Бейджи удачи, ранг среди игроков Guideshin и серия побед 50:50. Ниже — Account Lab: цель на баннер и прогноз, хватит ли круток при вашем стиле игры.",
  },
  {
    id: "fivestars",
