...
export default function GuideCalculators({ characterName }: { characterName: string }) {
  ...
  return (
    <section
      id="guide-calc"
      className="rounded-[18px] bg-card p-4 shadow-soft sm:p-5 dark:shadow-none"
    >
      <div className="mb-4">
      ...
      <div className="grid gap-3.5 lg:grid-cols-2">
        <CalcCard title="Уровень персонажа">
          ...
          <div className="mb-3 overflow-hidden rounded-[14px] bg-card p-3">
...
function CalcCard({ title, children }: { title: string; children: ReactNode }) {
  return (
    <div className="rounded-[16px] bg-muted/70 p-4 dark:bg-white/[0.04]">
...
function ResultRow({
  ...
  return (
    ...
    >
      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-muted dark:bg-white/[0.06]">
        {icon ? (
